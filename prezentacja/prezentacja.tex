...
\begin{frame}[fragile,allowframebreaks]
  \frametitle{Pułapka kwalifikatorów}
{\small
\begin{verbatim}
$ morfeusz_analyzer
...
zamkiem
[0,1,zamkiem,zamek:s1,subst:sg:inst:m3,pospolita,_
 0,1,zamkiem,zamek:s2,subst:sg:inst:m3,pospolita,_]
terminalami
[0,1,terminalami,terminal:s1,subst:pl:inst:m3,pospolita,_
 0,1,terminalami,terminal:s2,subst:pl:inst:m3,pospolita,_]
\end{verbatim}
...
Using dictionary: sgjp (default)
waluta
[0,1,waluta,waluta:s1,subst:sg:nom:f,pospolita,ekon.
 0,1,waluta,waluta:s2,subst:sg:nom:f,pospolita,pot.]
cykoria
[0,1,cykoria,cykoria:s1,subst:sg:nom:f,pospolita,bot.
 0,1,cykoria,cykoria:s2,subst:sg:nom:f,pospolita,pot.]
karma
[0,1,karma,karma:s1,subst:sg:nom:f,pospolita,_
 0,1,karma,karma:s2,subst:sg:nom:f,pospolita,rel.]
Czechowi
[0,1,Czechowi,Czech:s2,subst:sg:dat:m1,nazwisko,_
 0,1,Czechowi,Czech:s1,subst:sg:dat:m1,pospolita,_]
...
\begin{frame}[allowframebreaks]
 ...
 58/fin/50\\
 60.22.11–00.00\\
% 60546.fizjks@iftia.univ.gda.pl
 6667/88/IV\\
% 9b16v3\$pmh\$1@news.onet.pl\\
 A.C\\
 AC+79\\
A.D.D.A.M\\
 A/H1N1\\
...
\begin{column}{.2\textwidth}
 ...
 Mawsu'at\\
 Miau.pl\\
% mniedziela@prezydent.pl\\
% Mozgolencia@interia.pl\\
 mrcheat@gazeta.pl\\
 m/s\\
 Na+\\
 ona\_\_\_@op.pl\\
...
% portalpomorza.pl\\
% Portalpomorza.pl
% posrednictwo@pro.onet.pl
% Potter's
% Przycisk2_1
% Quake'a
% rad_rez@poczta.onet.pl
\end{column}
% \begin{column}
...
% Sportingbet.com
% SS'man
% store.britannica.com
% Strona\|Format\\
% synapse@friko2.onet.pl
% szybko.pl\\
% techandtradelaw.blogspot.com
% T.Love
% trader.pl
% Traveller's
% t–shirt
% U.S.
% vojtus@poczta.onet.pl
% White's
% windykacja.pl\\
% Woman's
% Writers'
...
% \begin{column}
% wrzuta.pl
% www.archiwalia.gov.pl
% www.blogspot.com
% www.colours.cz
% www.englishinbritain.com
% www.eures.praca.gov.pl
% www.europetnet.com
% www.felispolonia.pl
% www.freshdevices.com
% www.gadki.lublin.pl/east/z/index.html
...
\beamertemplatearticlebibitems
\bibitem[Petkevič, 2014]{petk:14}
Petkevič, Vladimír, 2014.
\newblock {P}roblémy automatické morfologické disambiguace češtiny.
\newblock Naše řeč  97, 4–5, s. 194–207.

\beamertemplatearticlebibitems
\bibitem[Jel\'{i}nek, 2008]{jelinek:08}
Jel\'{i}nek, Tom\'{a}\v{s}, 2008.
\newblock {N}ov\'{e} zna\v{c}kov\'{a}n\'{i} v~{\v{C}}esk\'{e}m n\'{a}rodn\'{i}m korpusu.
\newblock Naše \v{r}e\v{c}  91, 1, s. 13–20.


\beamertemplatearticlebibitems
\bibitem[Straka, 2014]{morphodita:14}
Strakov\'{a}, Jana  and  Straka, Milan  and  Haji\v{c}, Jan
\newblock {Open-{S}ource {T}ools for {M}orphology, {L}emmatization, {POS} {T}agging and {N}amed {E}ntity {R}ecognition}
\newblock {Proceedings of 52nd Annual Meeting of the Association for Computational Linguistics: System Demonstrations.}

\beamertemplatearticlebibitems
\bibitem[Czerepowicka, 2014]{sejf:14}
Czerepowicka, Monika 2014
\newblock {{SEJF} -- {S}łownik elektroniczny jednostek frazeologicznych}
\newblock {{J}ęzyk {P}olski, 2, 116-129.}
