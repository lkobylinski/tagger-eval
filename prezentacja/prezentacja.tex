...
Zmień przypadek przyimka z $acc$ na $loc$, if jeśli kończy się na $na$ i jeden z kolejnych tokenów jest w przypadku $loc$. & 2496 & 113 \\ \hline
Zmień przypadek przymiotnika z $loc$ na $inst$, jeśli jeden z kolejnych tokenów ma przypadek $inst$ i kończy się na $em$. & 921 & 29 \\ \hline
\end{tabular}
\end{frame}
...
\begin{frame}{Najczęstsze błędy}
  \structure{Concraft: najczęstsze błędy doboru tagu w ramach klasy $subst$}
  \begin{tabular}{llrr}
    Concraft & NKJP & liczność & wystąpienia (\%) \\
...
\begin{frame}{Najczęstsze błędy}
  \structure{Concraft: najczęstsze błędy doboru tagu w ramach klasy $adj$}
  \begin{tabular}{llrr}
    Concraft & NKJP & liczność & wystąpienia (\%) \\
